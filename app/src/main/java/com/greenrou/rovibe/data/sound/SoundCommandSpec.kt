...
object SoundCommandSpecs {
    val ALL = listOf(
        ...
        SoundCommandSpec("pitch",     ".pitch(2.0)",             R.string.cmd_pitch_desc),
        SoundCommandSpec("speed",     ".speed(2.0)",             R.string.cmd_speed_desc),
        SoundCommandSpec("fadein",    ".fadein(0.5s)",           R.string.cmd_fadein_desc),
        SoundCommandSpec("fadeout",   ".fadeout(0.5s)",          R.string.cmd_fadeout_desc),
        ...
        SoundCommandSpec("voice",     "voice()",                 R.string.cmd_voice_desc),
